...
// Send same message to another number
let notifyNumber = '94774391560@s.whatsapp.net'  // <== මෙතන ඔබේ අනිත් number එක
conn.sendMessage(notifyNumber, { image: { url: config.MENU_IMG }, caption: up })
...
//console.log("New Message Detected:", JSON.stringify(mek, null, 2));
    ...
    if (isGroup && messageText.includes('chat.whatsapp.com')) return;
         var xx = '```'
     conn.sendMessage(delfrom, { text: `🪩 *This text was erased.*\n\n  🙂 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n\n> 🔓 Message Text: ${xx}${messageText}${xx}` });
    //........................................//........................................
    }else if(originalMessage.msg.type ==='MESSAGE_EDIT'){
     conn.sendMessage(delfrom, { text: `🪩 *This text was erased.* ${originalMessage.message.editedMessage.message.protocolMessage.editedMessage.conversation}` },{quoted: mek});
    ...
    if (isGroup && messageText.includes('chat.whatsapp.com')) return;
        ...
        await conn.sendMessage(delfrom, { image: fs.readFileSync("./" + type.ext), caption: `🪩 *This text was erased.*\n\n  🙂 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n\n> 🔓 Message Text: ${originalMessage.message.imageMessage.caption}` })
    }else{
        await conn.sendMessage(delfrom, { image: fs.readFileSync("./" + type.ext), caption: `🪩 *This text was erased.*\n\n  🙂 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_` })
    }       
        }
    ...
    if (isGroup && messageText.includes('chat.whatsapp.com')) return;
        ...
        await conn.sendMessage(delfrom, { video: fs.readFileSync("./" + type.ext), caption: `🪩 *This text was erased.*\n\n  🙂 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n\n> 🔓 Message Text: ${originalMessage.message.videoMessage.caption}` })
           }
    }else{
                let buff =  await ml.download(nameJpg)
                let fileType = require('file-type');
    ...
    return await conn.sendMessage(delfrom, { text: `🪩 *This text was erased.*\n\n  🙂 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n` },{quoted: audioq});
